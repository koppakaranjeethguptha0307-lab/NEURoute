...
class Vehicle(Base):
    ...
    id = Column(String(50), primary_key=True, index=True, default=lambda: f"veh-{uuid.uuid4().hex[:8]}")
    ...
    assigned_hub_id = Column(String(50), ForeignKey("logistics_hubs.id"), nullable=True)
    ...
    gps_source = Column(String(20), default="SIMULATED", nullable=True)  # SIMULATED, LIVE
